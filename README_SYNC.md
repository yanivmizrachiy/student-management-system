...
|----------------|---|---------------------------|
| `students.full_name` | → | `students.first_name` |
| `students.phone` | → | שדה חדש (אם קיים) |
| `lessons` | → | `assessments` (ציונים) |
| `payments` | → | שדה notes ב-students |
...
💡 **אפשר להריץ כמה פעמים - הסקריפט חכם ולא משכפל**
